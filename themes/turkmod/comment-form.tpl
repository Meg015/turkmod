...
<div class="ui-comment-form-avatar default-avatar">{if topic.current_user_avatar}<img src="{topic.current_user_avatar}" alt="{topic.current_user_name}" title="{topic.current_user_name}" width="40" height="40" loading="lazy" data-ui-avatar-img data-ui-avatar-fallback="{topic.avatar_fallback}">{else}<img src="{topic.avatar_fallback}" alt="{topic.current_user_name}" title="{topic.current_user_name}" width="40" height="40" loading="lazy" data-ui-avatar-img data-ui-avatar-fallback="{topic.avatar_fallback}">{/if}</div>
