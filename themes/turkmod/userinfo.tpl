<section class="ui-theme-profile-template" data-page-template="profile" data-profile-public="{profile.is_public}" data-profile-private="{profile.is_private}" aria-label="{profile.username}">
{if profile.cover}
...
<span data-profile-name>{profile.username}</span>
