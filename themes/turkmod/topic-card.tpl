...
<img class="ui-theme-topic-card__image" src="{topic.image}" alt="{topic.image_alt}" width="800" height="450" loading="{topic.image_loading}" decoding="{topic.image_decoding}"{if topic.image_srcset} srcset="{topic.image_srcset}"{/if}{if topic.image_sizes} sizes="{topic.image_sizes}"{/if}{if topic.image_fetchpriority} fetchpriority="{topic.image_fetchpriority}"{/if}>
