...
function adminSettingDefinitions(): array
{
    ...
    $definitions = [
        ...
        'comment_form_info_text'     => ['label' => 'Yorum Bilgi Metni', 'type' => 'text', 'default' => 'Spam, anlamsız veya tekrarlı yorumlar otomatik olarak engellenir. Lütfen konuya katkı sağlayan bir yorum yazın.', 'section' => 'comments', 'rows' => 2, 'tooltip' => 'Yorum kutusunun sol alt köşesinde gösterilecek kısa bilgilendirme metni. Boş bırakılırsa bilgi alanı gizlenir.'],
        ...
        'comment_spam_violation_action' => ['label' => 'Spam’e Takılan Yorum Ne Yapılsın?', 'type' => 'select', 'default' => 'reject', 'section' => 'comments', 'options' => ['reject' => 'Yorumu Reddet ve Kullanıcıya Yorumu Düzenlemesini Söyle', 'pending' => 'Onaya düşür'], 'tooltip' => 'Spam filtresine takılan yorumun kaydedilmeden reddedileceğini veya onaya gönderileceğini belirler.'],
        ...
        'comment_spam_nonsense_words_enabled' => ['label' => 'Anlamsız Kelime Engelleme', 'type' => 'bool', 'default' => '1', 'section' => 'comments', 'tooltip' => 'Açıksa safasfasfsafasa, asdfasdfasdf, qweqweqwe, rhsrh, r6ytu, 1235612 gibi tekrarlı, klavye dizisi, uzun sayı veya rastgele harf/rakam görünen yorumları spam olarak işaretler. Normal cümle içindeki tek garip kelime için daha toleranslı davranır.'],
        ...
        // -- Mod Yükle (Kullanıcı) ------------------------------
        'user_upload_enabled'    => ['label' => 'Kullanıcılar Mod Yükleyebilir', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Genel', 'tooltip' => 'Kapalıysa kullanıcı tarafındaki Mod Yükle sayfası erişime kapanır.'],
        'user_upload_require_approval' => ['label' => 'Modlar Onay Gerektirir', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Akış', 'tooltip' => 'Açıksa kullanıcı gönderileri yayınlanmadan önce moderatör veya admin onayına düşer.'],
        'user_upload_default_status' => ['label' => 'Onaysız Gönderim Durumu', 'type' => 'select', 'default' => 'published', 'section' => 'user_uploads', 'group' => 'Akış', 'options' => ['published' => 'Yayında', 'draft' => 'Taslak'], 'tooltip' => 'Onay zorunlu değilse yeni kullanıcı modlarının hangi durumla kaydedileceğini belirler.'],
        'user_upload_require_cover' => ['label' => 'Kapak Görseli Zorunlu', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Zorunlu Alanlar', 'tooltip' => 'Kullanıcı mod gönderirken kapak görseli yüklemek zorunda kalır.'],
        'user_upload_require_gallery' => ['label' => 'En Az 1 Galeri Görseli Zorunlu', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Zorunlu Alanlar', 'tooltip' => 'Galeri adımında en az bir görsel yüklenmeden gönderime izin verilmez.'],
        'user_upload_require_author' => ['label' => 'Yapımcı Alanı Zorunlu', 'type' => 'bool', 'default' => '0', 'section' => 'user_uploads', 'group' => 'Zorunlu Alanlar', 'tooltip' => 'Kullanıcı mod gönderirken yapımcı bilgisini doldurmak zorunda kalır.'],
        'user_upload_require_version' => ['label' => 'Oyun Sürümü Zorunlu', 'type' => 'bool', 'default' => '0', 'section' => 'user_uploads', 'group' => 'Zorunlu Alanlar', 'tooltip' => 'Kullanıcı mod gönderirken uyumlu oyun sürümünü doldurmak zorunda kalır.'],
        'user_upload_require_download_link' => ['label' => 'İndirme Linki Zorunlu', 'type' => 'bool', 'default' => '0', 'section' => 'user_uploads', 'group' => 'Zorunlu Alanlar', 'tooltip' => 'En az bir indirme kaynağı girilmeden gönderime izin verilmez.'],
        'user_upload_min_title_length' => ['label' => 'Minimum Başlık Uzunluğu', 'type' => 'number', 'default' => '3', 'section' => 'user_uploads', 'group' => 'Kalite', 'tooltip' => 'Mod başlığının kabul edilmesi için gereken en az karakter sayısı.'],
        'user_upload_max_title_length' => ['label' => 'Maksimum Başlık Uzunluğu', 'type' => 'number', 'default' => '150', 'section' => 'user_uploads', 'group' => 'Kalite', 'tooltip' => 'Mod başlığında izin verilen en fazla karakter sayısı.'],
        'user_upload_min_content_length' => ['label' => 'Minimum Açıklama Uzunluğu', 'type' => 'number', 'default' => '10', 'section' => 'user_uploads', 'group' => 'Kalite', 'tooltip' => 'Mod açıklamasının kabul edilmesi için gereken en az metin uzunluğu.'],
        'user_upload_max_images' => ['label' => 'Maksimum Galeri Görseli', 'type' => 'number', 'default' => '10', 'section' => 'user_uploads', 'group' => 'Görsel Kuralları', 'tooltip' => 'Bir mod gönderisinde yüklenebilecek en fazla galeri görseli sayısı.'],
        'user_upload_cover_max_size_mb' => ['label' => 'Kapak Maksimum Boyut (MB)', 'type' => 'number', 'default' => '10', 'section' => 'user_uploads', 'group' => 'Görsel Kuralları', 'tooltip' => 'Kapak görseli için izin verilen en büyük dosya boyutu.'],
        'user_upload_gallery_max_size_mb' => ['label' => 'Galeri Görseli Maksimum Boyut (MB)', 'type' => 'number', 'default' => '10', 'section' => 'user_uploads', 'group' => 'Görsel Kuralları', 'tooltip' => 'Her galeri görseli için izin verilen en büyük dosya boyutu.'],
        'user_upload_allowed_image_ext' => ['label' => 'İzinli Görsel Uzantıları', 'type' => 'string', 'default' => 'jpg,jpeg,png,webp', 'section' => 'user_uploads', 'group' => 'Görsel Kuralları', 'tooltip' => 'Kapak ve galeri yüklemelerinde kabul edilecek görsel uzantılarını virgülle ayırın.'],
        'user_upload_image_min_width' => ['label' => 'Görsel Minimum Genişlik (px)', 'type' => 'number', 'default' => '0', 'section' => 'user_uploads', 'group' => 'Görsel Kuralları', 'tooltip' => 'Kapak ve galeri görselleri için minimum genişlik. 0 girilirse sınır uygulanmaz.'],
        'user_upload_image_min_height' => ['label' => 'Görsel Minimum Yükseklik (px)', 'type' => 'number', 'default' => '0', 'section' => 'user_uploads', 'group' => 'Görsel Kuralları', 'tooltip' => 'Kapak ve galeri görselleri için minimum yükseklik. 0 girilirse sınır uygulanmaz.'],
        'user_upload_image_max_width' => ['label' => 'Görsel Maksimum Genişlik (px)', 'type' => 'number', 'default' => '0', 'section' => 'user_uploads', 'group' => 'Görsel Kuralları', 'tooltip' => 'Kapak ve galeri görselleri için maksimum genişlik. 0 girilirse sınır uygulanmaz.'],
        'user_upload_image_max_height' => ['label' => 'Görsel Maksimum Yükseklik (px)', 'type' => 'number', 'default' => '0', 'section' => 'user_uploads', 'group' => 'Görsel Kuralları', 'tooltip' => 'Kapak ve galeri görselleri için maksimum yükseklik. 0 girilirse sınır uygulanmaz.'],
        'user_upload_allow_video_url' => ['label' => 'Video URL Alanına İzin Ver', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Video ve Linkler', 'tooltip' => 'Kullanıcı formunda tanıtım videosu URL alanının görünmesini ve kaydedilmesini sağlar.'],
        'user_upload_allowed_video_hosts' => ['label' => 'İzinli Video Sağlayıcıları', 'type' => 'string', 'default' => 'youtube.com,youtu.be,vimeo.com', 'section' => 'user_uploads', 'group' => 'Video ve Linkler', 'tooltip' => 'Virgülle ayırın. Boş bırakılırsa tüm video URLleri kabul edilir.'],
        'user_upload_max_size_mb' => ['label' => 'Mod Dosyası Maksimum Boyut (MB)', 'type' => 'number', 'default' => '50', 'section' => 'user_uploads', 'group' => 'Limitler', 'tooltip' => 'Opsiyonel mod dosyası veya ek dosya yüklemesi için izin verilen en büyük boyut.'],
        ...
        'user_upload_block_duplicate_titles' => ['label' => 'Aynı Başlıkla Tekrar Gönderimi Engelle', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Kalite', 'tooltip' => 'Aynı kullanıcının aynı başlıkla tekrar mod göndermesini engeller.'],
        'user_upload_default_content_align' => ['label' => 'Varsayılan Açıklama Hizası', 'type' => 'select', 'default' => 'center', 'section' => 'user_uploads', 'group' => 'Form Davranışı', 'options' => ['left' => 'Sol', 'center' => 'Orta', 'right' => 'Sağ'], 'tooltip' => 'Kullanıcı açıklama metni için varsayılan hizalamayı belirler.'],
        'user_upload_submission_notice' => ['label' => 'Gönderim Sonrası Bilgilendirme Metni', 'type' => 'text', 'default' => 'Onay durumunu Profil > Konularım menüsünden takip edebilirsiniz.', 'section' => 'user_uploads', 'group' => 'Form Davranışı', 'tooltip' => 'Başarılı gönderimden sonra kullanıcıya gösterilecek takip veya bilgilendirme metni.'],
        'user_upload_lock_after_submit' => ['label' => 'Başarılı Gönderimden Sonra Butonu Kilitle', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Form Davranışı', 'tooltip' => 'Başarılı gönderimden sonra tekrar tıklamayı ve çift gönderimi önlemek için butonu kilitler.'],
        'user_upload_wizard_enabled' => ['label' => 'Wizard Arayüzü Aktif', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Form Davranışı', 'tooltip' => 'Mod yükleme formunu adım adım wizard arayüzüyle gösterir.'],
        'user_upload_allow_step_skip' => ['label' => 'Wizard Adımı Atlamaya İzin Ver', 'type' => 'bool', 'default' => '0', 'section' => 'user_uploads', 'group' => 'Form Davranışı', 'tooltip' => 'Açıksa kullanıcı zorunlu kontrolleri tamamlamadan wizard adımları arasında gezebilir.'],
        'user_upload_show_profile_followup' => ['label' => 'Son Adımda Profil Takip Kutusu Göster', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Form Davranışı', 'tooltip' => 'Onay adımında kullanıcıya gönderisini profilinden takip edebileceğini hatırlatan kutuyu gösterir.'],
        'user_upload_show_profile_button' => ['label' => 'Konularıma Git Butonu Göster', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Form Davranışı', 'tooltip' => 'Profil takip kutusunda Konularıma Git bağlantısını gösterir veya gizler.'],

        // -- Kelime Filtresi -----------------------------------
        'content_moderation_enabled' => ['label' => 'Kelime Filtresi Aktif', 'type' => 'bool', 'default' => '1', 'section' => 'user_uploads', 'group' => 'Kelime Filtresi', 'tooltip' => 'Kapalıysa yasak kelime taraması ve otomatik moderasyon bayrağı devre dışı kalır. Onay ve zorunlu alan ayarları çalışmaya devam eder.'],
        'content_moderation_blocked_words' => ['label' => 'Yasak Kelime Listesi', 'type' => 'text', 'default' => '', 'section' => 'user_uploads', 'group' => 'Kelime Filtresi', 'tooltip' => 'Virgül veya satır ile ayırın. Başlık ve açıklama metninde aranır.'],
        'content_moderation_blocked_words_action' => ['label' => 'Yasak Kelime Aksiyonu', 'type' => 'select', 'default' => 'draft', 'section' => 'user_uploads', 'group' => 'Kelime Filtresi', 'options' => ['draft' => 'Taslak + Moderasyon Bayrağı', 'reject' => 'Gönderimi Reddet', 'flag' => 'Yayına Al + Moderasyon Bayrağı'], 'tooltip' => 'Yasak kelime bulunduğunda konuya uygulanacak davranışı belirler.'],
        'content_moderation_blocked_words_message' => ['label' => 'Reddetme Mesajı', 'type' => 'string', 'default' => 'İçerikte izin verilmeyen kelime bulundu. Lütfen metni düzenleyin.', 'section' => 'user_uploads', 'group' => 'Kelime Filtresi'],
        'content_moderation_flag_note' => ['label' => 'Moderasyon Bayrağı Notu', 'type' => 'string', 'default' => 'Otomatik içerik moderasyonu incelemesi gerekiyor.', 'section' => 'user_uploads', 'group' => 'Kelime Filtresi'],
        ...
        'topic_require_excerpt' => [
            ...
            'group' => 'Kalite',
            'tooltip' => 'Kullanıcı mod gönderirken açıklama alanının doldurulmasını zorunlu kılar.'
        ],
        'topic_user_edit_requires_approval' => [
            ...
            'section' => 'user_uploads',
            'group' => 'Akış',
            'tooltip' => 'Kullanıcı kendi modunu düzenlediğinde değişikliğin yeniden moderasyon onayına düşmesini sağlar.'
        ],
