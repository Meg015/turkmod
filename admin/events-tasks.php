...
if (!in_array($tab, ['management', 'rules'], true)) {
    $tab = 'management';
}

$pageTitle = $tab === 'rules' ? 'Puan Kuralları' : 'Görev Yönetimi';
...
ob_start();
if ($tab === 'management') {
    require_once __DIR__ . '/../includes/src/Modules/Events/Admin/tasks.php';
} elseif ($tab === 'rules') {
    require_once __DIR__ . '/../includes/src/Modules/Events/Admin/activity-rules.php';
}
