...
/**
 * Backwards-compatible facade alias.
 *
 * `App\Core\Database` previously resolved to this file directly while a
 * parallel `App\Core\Database` namespace existed in includes/src/Core/Database/.
 * The concrete class was renamed to `DatabaseConnection` to eliminate the
 * class/namespace clash. This thin subclass keeps existing callers that still
 * reference `App\Core\Database::connection()` / `::getEnvConfig()` working
 * without any change at their call sites.
 *
 * @deprecated Use App\Core\DatabaseConnection directly in new code.
 */
final class Database extends DatabaseConnection
{
}