        ...
        if ($action === "update_profile") {
            try {
                ...
                $_SESSION["_auth_user_name"] =
                    trim($_POST["name"] ?? "") ?: $_SESSION["_auth_user_name"];
...
$profile_private_name = (string) ($profileContext['name'] ?? '');
        ...
        <form method="post" action="<?= $baseUri ?>/profile.php?tab=settings">
            ...
            <div class="profile-form-row">
                <div class="profile-form-group">
                    <label for="pf_name">Ad Soyad</label>
                    <input type="text" id="pf_name" name="name" value="<?= htmlspecialchars(
                        $user["name"],
