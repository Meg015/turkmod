...
final class NotificationSuppressionLogService
{
    ...
    private const REASON_META = [
        ...
        'template_disabled' => ['label' => 'Şablon kapalı', 'class' => 'none', 'icon' => 'bi-file-earmark-x'],
        'template_channels_disabled' => ['label' => 'Şablon kanalı kapalı', 'class' => 'none', 'icon' => 'bi-diagram-2'],
