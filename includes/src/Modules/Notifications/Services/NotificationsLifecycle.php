...
final class NotificationsLifecycle implements ModuleLifecycle
{
    public function onInstall(): void
    {
        $runner = new MigrationRunner($this->pdo(), 'notifications_migrations');
    ...
    private function pdo(): PDO
    {
        ...
        if (!$pdo instanceof PDO) {
            throw new RuntimeException('Notifications lifecycle requires an active PDO connection.');
        }
