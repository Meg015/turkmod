    ...
    if ($pdo && $title !== "" && $content !== "" && $categoryId > 0) {
        try {
            ...
            uploadTopicRespond(true, $uploadSuccessMessage, 200, [
                "redirect" => routePrivateProfileUrl(['tab' => 'topics', 'topic_status' => $uploadRedirectStatus, 'submitted' => '1']),
                "topic_id" => $topicId,
            ]);
        } catch (Throwable $e) {
...
<div class="ui-container container pb-5 upload-topic-form-container">
    ...
    (int) ($category["depth"] ?? 0),
                    ...
                    <div class="upload-profile-followup">
                        ...
                        <a href="<?= htmlspecialchars(routePrivateProfileUrl(['tab' => 'topics']), ENT_QUOTES, 'UTF-8') ?>" class="upload-profile-followup-link">Konularıma Git</a>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
